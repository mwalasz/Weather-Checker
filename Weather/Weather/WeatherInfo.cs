...
namespace HTML
{
    class WeatherInfo
    {
        ...
        public static void DownloadWeatherInfo(double[] data, string[] labels, string[] units,
        ...
        {
            DownloadWeatherInfo(DataArray,LabelTextsArray, UnitsArray, FinalWeatherInfoToDisplay, WindDirection);
            Console.Read();
        }
    }
}
